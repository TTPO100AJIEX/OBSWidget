...
async function register(app, options)
{
    ...
    {
        res.header('Report-To', `{"group":"obswidget","max_age":10886400,"endpoints":[{"url": "https://${req.hostname}/csp-violation-report"}]}`);
        res.header('Reporting-Endpoints', `obswidget="/csp-violation-report"`);
        next();
    });
