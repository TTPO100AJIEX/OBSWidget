...
async function register(app, options)
{
    ...
    {
        if (login != config.application.login || password != config.application.password)
        ...
        await DatabaseCache.setExpire(`session_id-${session_id}`, JSON.stringify({ ok: true }), interval);
